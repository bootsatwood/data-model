...
**V13.3 NOTE**: This version consolidates barrier columns into single Barrier field (1,383 facilities), restructures documentation for clarity, and provides complete fee and revenue calculation methodology.
...
- Minor fixes: V13.3 → V13.4 → V13.5
- Major changes: V13.x → V14.0
...
### 3.8 V13.3 Key Metrics

| Metric | Scenario 1 | Scenario 2 | Scenario 3 |
|--------|------------|------------|------------|
| Current Revenue | $177,684,185 | $195,452,682 | $213,221,179 |
| Integration Revenue | $147,384,026 | $162,122,440 | $176,860,854 |
| New Business Revenue | $5,115,910,599 | $5,627,503,906 | $6,139,097,213 |
| **Total Potential** | **$5,263,294,625** | **$5,789,626,346** | **$6,315,958,067** |
...
2. Group by TAM/SAM/SOM segment (apply filters from Section 4.4)
...
2. Group by TAM/SAM/SOM segment
...
**Methodology:**
1. Filter to SOM segment only (Existing markets, Corporate, minus barriers)
...
**Special Handling:** Independent facilities are grouped as "INDEPENDENT" entity.
...
|---------|------|-------------|
| **V13.3** | Nov 2025 | Updated fee structure with walked-out math, corrected scenario definitions |
| V13.2 | Nov 2025 | Added comprehensive report methodology |
